<?php
    ...
    function db_questions_get($con){
        $consulta = file_get_contents("./src/db/questions_db.sql");
    ...
    function save_question($con, $response_arreglo){
        ...
        $con->query("INSERT INTO respuestas VALUES(null, '$ids[0]', '$ids[1]', '$ids[2]', '$ids[3]', '$ids[4]', '$ids[5]', '$ids[6]', '$ids[7]', '$ids[8]', '$ids[9]', '$ids[10]', '$ids[11]')");
        return true;
    }
